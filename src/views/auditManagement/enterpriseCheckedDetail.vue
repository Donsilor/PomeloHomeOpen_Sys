    ...
    <el-card class="box-card">
      ...
      <el-row class="card-row">
        ...
        <el-col :span="15" :offset="1" class="card-span-right" >
          <el-button type="primary" style="margin-bottom: 5px" v-for="item in checkDetail.brands" :key="item.name">{{item.brand_name}}</el-button>
        </el-col>
      </el-row>
      ...
      <el-row class="card-row">
        ...
        <el-col :span="15" :offset="1" class="card-span-right" >
          <el-button type="primary" style="margin-bottom: 5px" v-for="item in checkDetail.type" :key="item.name">{{item.name}}</el-button>
        </el-col>
      </el-row>
    </el-card>
