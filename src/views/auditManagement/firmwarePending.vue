    ...
    <div class="app-container calendar-list-container">
        ...
        <el-table :data="list" v-loading="listLoading" element-loading-text="给我一点时间" stripe fit highlight-current-row
            ...
            <el-table-column align="center" label="操作" width="150">
                <template slot-scope="scope">
                    <el-button v-if="scope.row.status!='published' && scope.row.can_approve" size="small" type="primary"
...
//      console.log('配置文件', productTechnologyType);
        ...
        methods: {
            ...
            goCheckDetail(row) {
                ...
                this.$router.push({path: '/auditManagement/firmwareToAudit', query: query});
            },
