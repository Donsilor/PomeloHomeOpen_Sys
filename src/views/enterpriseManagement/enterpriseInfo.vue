  ...
  <el-row style="padding-left: 160px;padding-bottom: 30px;">
    ...
    <div class="app-container">
      ...
      <el-row style="margin-bottom: 10px;">
        ...
        <el-button 
          ...
          size="medium" 
          @click="doEdit">{{ edit?'确定并提交修改':'编辑厂商信息' }}</el-button>
      </el-row>
      ...
      <el-form 
        ...
        <el-card class="box-card">
          ...
          <el-row class="card-body">
            ...
            <el-form-item 
              ...
              <el-input 
                :class="{'no-border':!edit}" 
                v-model="checkDetail.contacts_mobile"/>
            </el-form-item>
            <el-form-item 
              label="职位" 
              prop="contacts_duty">
              <el-input 
                :class="{'no-border':!edit}" 
                v-model="checkDetail.contacts_duty"/>
            </el-form-item>
          </el-row>
        </el-card>
        <el-card class="box-card">
          ...
          <el-row class="card-body">
            ...
            <el-form-item 
              ...
              <el-input 
                :class="{'no-border':!edit}" 
                v-model="checkDetail.registration_No"/>
            </el-form-item>
            <el-form-item 
              label="客服电话" 
              prop="customer_num">
              <el-input 
                :class="{'no-border':!edit}" 
                v-model="checkDetail.customer_num"/>
            </el-form-item>
            <el-form-item 
              label="合作产品" 
              prop="type">
              <div :style="{paddingLeft: edit?0:15+'px'}">
                <el-tag 
                  v-for="(item,index) in checkDetail.type" 
                  :key="item.name" 
                  :closable="edit"
                  type="success" 
                  style="margin: 0 10px 10px 0;" 
                  @close="removeType(index,item)">
                  {{ item.name }}
                </el-tag>
                <el-button 
                  v-if="edit" 
                  type="primary" 
                  size="small" 
                  @click="checkTypeList">+添加更多</el-button>
              </div>
            </el-form-item>
            <el-form-item 
              label="合作品牌" 
              prop="brands">
              <div 
                v-for="(item,index) in checkDetail.brands" 
                :class="{'edit-brand-box':edit}" 
                :key="index" 
                class="brand-box">
                <el-row>
        ...
        <el-card class="box-card">
          ...
          <el-form-item 
            v-for="(item,index) in checkDetail.licenses" 
            :label="item.filename" 
            :key="item.file_id" 
            class="license-box">
            <img 
            ...
            >
              <el-button 
                size="small" 
                type="primary">更换资质</el-button>
            </el-upload>
            <el-button 
              v-if="edit&&(item.type==6||item.type==7||item.type==8)" 
              type="primary" 
              class="remove-liscense"
              size="small" 
              @click="removeLicense(index)">删除资质</el-button>
          </el-form-item>
    ...
    <el-dialog
      ...
      <span 
        ...
        <el-button 
          type="primary" 
          @click="addLicense">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      ...
      <el-form 
        ...
        <el-form-item 
          ...
          <el-input 
            ...
            :maxlength="10" 
            placeholder="请输入品牌名称，10个字内"/>
        </el-form-item>
        <el-form-item 
          label="品牌英文" 
          prop="name_e">
          <el-input 
            v-model="brandForm.name_e" 
            :maxlength="32" 
        ...
        <el-form-item 
          label="品牌中英文&商标资格证，回执加盖公章" 
          prop="cert" 
          class="ff">
          <el-input 
            v-model="brandForm.cert" 
            style="width: 72%;" 
            readonly 
            placeholder="商标未注册完成的上传商标注册记录"/>
          <el-upload 
            :on-success="handeler"
            :before-upload="beforeImgUpload"
            :show-file-list="false"
