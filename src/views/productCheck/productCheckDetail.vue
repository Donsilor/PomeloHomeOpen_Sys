...
<div class="app-container">
  ...
  <el-card class="box-card">
    <el-row slot="header" class="card-row">
        ...
        <el-col :span="20" :offset="2" class="card-span-right">{{checkDetail.type_name}}</el-col>
    </el-row>

    <el-row slot="header" class="card-row">
      <el-col :span="2" class="card-span-left">产品品牌</el-col>
      <el-col :span="20" :offset="2" class="card-span-right">{{checkDetail.brand_name}}</el-col>
    </el-row>

    <el-row slot="header" class="card-row">
      <el-col :span="2" class="card-span-left">产品名称</el-col>
      <el-col :span="20" :offset="2" class="card-span-right">{{checkDetail.name}}</el-col>
    </el-row>
    ...
    <el-row slot="header" class="card-row">
      ...
      <el-col :span="20" :offset="2" class="card-span-right"><a :href="checkDetail.spec_url">{{checkDetail.spec_name}}</a></el-col>
    </el-row>

    <el-row slot="header" class="card-row">
      <el-col :span="2" class="card-span-left">产品使用说明书</el-col>
      <el-col :span="20" :offset="2" class="card-span-right"><a :href="checkDetail.instruct_url">{{checkDetail.instruct_name}}</a></el-col>
    </el-row>
  ...
  <el-card class="box-card">
    ...
    <!--<el-row slot="header" class="card-row">-->
      <!--<el-col :span="2" class="card-span-left">模组/芯片信息</el-col>-->
      <!--<el-col :span="20" :offset="2" class="card-span-right">-->
        <!--{{checkDetail.type_txt}}-->
      <!--</el-col>-->
    <!--</el-row>-->
    ...
    <el-row slot="header" class="card-row">
      <el-col :span="2" class="card-span-left">型号
      </el-col>
      <el-col :span="20" :offset="2" class="card-span-right">
