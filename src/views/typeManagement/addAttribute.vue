  ...
  <div class="attDialog">
    <el-dialog 
      ...
      <el-form 
          ...
          <el-col :span="22">
            <el-form-item 
              ...
              <el-input 
                v-model="form.nodeid" 
                class="input-width" 
                placeholder="仅支持字母、下划线输入，最多32个字符"/>
            </el-form-item>
        ...
        <el-row 
          v-for="(paramKey,paramIndex) in form.value_list" 
          :key="paramIndex" 
          class="first-item">
          <div>
            <el-col 
            ...
            <el-col :span="22">
              ...
              >
                <el-input 
                  v-model="paramKey.unit" 
                  placeholder="支持中英文、特殊字符，最多16个字符" 
                  class="input-width"/>
              </el-form-item>
              <el-form-item 
              ...
              <el-form-item 
                ...
                class="w100p pl8">
                <el-radio-group 
                  v-model="paramKey.type" 
                  @change="changeTypeValue($event,paramKey)">
              ...
              <el-form-item 
                v-if="['string','float','array','bool'].indexOf(paramKey.type)>=0" 
                label="复选/单选" 
                class="w100p pl8">
              ...
              <el-form-item 
                v-if="paramKey.type=='otc'" 
                label="参数值" 
                class="w100p pl8">
                <el-input 
                  v-model="paramKey.value_list[0].value_des" 
                  style="width: 50%;" 
                  placeholder="数据说明"/>
                <span>数据由厂商端输入</span>
              </el-form-item>
              <template v-if="paramKey.key_type==1">
                ...
                <el-form-item 
                  v-for="(valueItem,listIndex) in paramKey.value_list" 
                  :key="listIndex" 
                  label=" " 
                  class="w100p mt0" >
                  <el-form-item 
                  ...
                  <el-form-item 
                    ...
                    <i 
                      ...
                      @click="delEnumerateItem(listIndex,paramKey)"/>
                  </el-form-item>
                </el-form-item>
                <el-form-item 
                  label=" " 
                  ...
                  <template slot-scope="scope">
                    <a 
                      ...
                      class="addbtn" 
                      @click="addEnumerateItem(paramKey)">
                      <i class="el-icon-plus"/> 添加更多参数值
                    </a>
                  </template>
                </el-form-item>
              </template>
              <div v-if="paramKey.key_type==2">
                <el-form-item 
                  ...
                  >
                    <el-input 
                      v-model.number="paramKey.value_list[1].value" 
                      placeholder="请输入数据最小值" 
                      class="input-width"/>
                  </el-form-item>
                  <el-form-item 
                    v-if="paramKey.value_list[2]" 
                  ...
                  >
                    <el-input 
                      v-model.number="paramKey.value_list[2].value" 
              ...
              <template v-if="paramKey.key_type==3">
                <div 
                  ...
                  <el-form-item 
                    ...
                    <el-radio-group 
                      v-model="em.type" 
                      @change="changeTypeValue($event,em)">
                      <el-radio label="string">string</el-radio>
                      <el-radio label="int">int</el-radio>
                      <el-radio label="float">float</el-radio>
                      <el-radio label="array">array</el-radio>
                  ...
                  <el-form-item 
                    ...
                    class="w100p pl8">
                    <el-radio-group 
                      v-if="['string','float','array','bool'].indexOf(em.type)>=0" 
                      v-model="em.is_checkbox">
                      <el-radio label="1">复选</el-radio>
                      <el-radio label="0">单选</el-radio>
                    </el-radio-group>
                  </el-form-item>
                  ...
                  <el-form-item 
                    ...
                    class="w100p pl8">
                    <el-input 
                      v-model="em.value_list[0].value_des" 
                      style="width: 50%;"/>
                    <span>数据由厂商端输入</span>
                  </el-form-item>
                  ...
                  <div v-if="em.key_type==2">
                    <el-form-item 
                      ...
                      >
                        <el-input 
                          v-model.number="em.value_list[1].value" 
                          placeholder="请输入数据最小值" 
                          class="input-width"/>
                      </el-form-item>
                      <el-form-item 
                        v-if="em.value_list[2]" 
                      ...
                      >
                        <el-input 
                          v-model.number="em.value_list[2].value" 
                          placeholder="请输入数据最大值" 
                          class="input-width"/>
                      </el-form-item>
                    </el-form-item>
                  ...
                  <div 
                    ...
                    <span 
                      class="el-icon-delete" 
                      title="删除参数" 
                      @click="deleteAttr(paramKey,i)"/>
                  </div>
                </div>
                <a 
                  href="javascript:void(0);" 
                  class="addAttr" 
                  @click="addAttribute(paramKey)"><i class="el-icon-plus"/> 新增属性</a>
              </template>
        ...
        <div class="buttonPos">
          <el-button 
            type="ghost" 
            class="addParams" 
            @click="addParams">新增参数</el-button>
        </div>
      </el-form>
      <div 
        slot="footer" 
        ...
        <el-button 
          type="primary" 
          @click="confirmTechnical">添 加</el-button>
      </div>
    </el-dialog>
  </div>
