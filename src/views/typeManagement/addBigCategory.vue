      ...
      <el-col :span="24" style="margin: 20px 0px;padding-bottom: 40px;">
        ...
        <el-col :span="24">
          <el-form :rules="rules" ref="ruleForm" :model="form" label-width="120px" style="margin-top: 20px;" size="large">
            ...
            <el-form-item label="品类图标" style="padding-bottom: 30px;">
              <el-col :span="12">
                <div class="fileuploadItem bigCategory">
                  <el-upload class="avatar-uploader" :class="disabled ? 'disabled' : ''" action="/api/index.php/producttype/iconupload" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload" accept="image/png" :disabled="disabled" :data="high_light_data">
                ...
                <div class="fileuploadItem bigCategory">
                  <el-upload class="avatar-uploader" :class="disabled ? 'disabled' : ''" action="/api/index.php/producttype/iconupload" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload" accept="image/png" :disabled="disabled" :data="normal_s_data">
                ...
                <div class="fileuploadItem bigCategory">
                  <el-upload class="avatar-uploader" :class="disabled ? 'disabled' : ''" action="/api/index.php/producttype/iconupload" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload" accept="image/png" :disabled="disabled" :data="normal_data">
                ...
                <div class="fileuploadItem bigCategory">
                  <el-upload class="avatar-uploader" :class="disabled ? 'disabled' : ''" action="/api/index.php/producttype/iconupload" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload" accept="image/png" :disabled="disabled" :data="disabled_data">
            ...
            <el-form-item label="大品类是否在设备选择列表显示（融合版APP）" class="line25">
              <el-col :span="12">
                <el-radio-group :disabled="disabled" v-model="form.app_show_in_select_list">
                  <el-radio :label="1">是</el-radio>
                  <el-radio :label="0">否</el-radio>
                </el-radio-group>
              </el-col>
            ...
            <el-form-item label="是否依赖路由器">
              <el-col :span="12">
                <el-checkbox :disabled="disabled" :true-label="1" :false-label="0" v-model="form.is_depend_router">是</el-checkbox>
              </el-col>
            </el-form-item>
